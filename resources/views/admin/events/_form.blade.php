...
<div class="row g-3">
  ...
  <div class="col-md-3">
    ...
    <input type="number" name="capacity" class="form-control" min="0" value="{{ old('capacity', $item->capacity ?? 0) }}">
  </div>
...
<div class="mt-3">
  ...
  <a class="btn btn-light" href="{{ route('admin.events.index') }}">Cancel</a>
</div>
